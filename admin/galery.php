        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <h3><i class=""></i> </h3>
                       <a href="tambah_galery.php" class="btn btn-primary mb-2" ><i class="fas fa-plus-circle"></i> Tambah Galery</a>
      ...
      <tr>
       <td><?php echo $no; ?></td>  
        <td><?php echo $row['nama']?></td>
                 <td><img height="100"= src="<?= 'galery_album/'.$row['gambar']?>"></td>
        <td><a href="<?= 'edit_galery.php?id='.$row['id_galery'] ?>"><button class="btn btn-danger"><i class="material-icons"></i>Edit</button></a> 

            <a href="<?= 'hapus_galery.php?id_galery='.$row['id_galery'] ?>" 
