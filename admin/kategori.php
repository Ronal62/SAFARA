    ...
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="kategori.php">Kategori Table</a></li>
                            <li class="breadcrumb-item"><a href="kategori.php">Kategori Tables</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <h3><i class=""></i> </h3>
                       <a href="tambah_kategori.php" class="btn btn-primary mb-2" ><i class="fas fa-plus-circle"></i> Tambah Kategori</a>
      ...
      <tr>
       <td><?php echo $no; ?></td>  
        ...
        <td><a href="<?= 'edit_kategori.php?id='.$row['id_kategori'] ?>"><button class="btn btn-danger"><i class="material-icons"></i>Edit</button></a> 
