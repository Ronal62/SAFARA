                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Form Galery</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="tambah_admin.php">Form Galery</a></li>
...
if (!in_array($ext, $ekstensi)) {
  ...
  $sql = mysqli_query($conn, "INSERT INTO galery VALUES( '', '$nama', '$nm')");
  if ($sql) {
   echo "
   <script>
 ...
 move_uploaded_file($_FILES['gambar']['tmp_name'], 'galery_album/'.$nm);
    }
  }
?>
