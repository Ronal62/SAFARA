                    ...
                    <div class="owl-carousel owl-carousel-2 carousel-item-1 position-relative mb-3 mb-lg-0">
                        <div class="position-relative overflow-hidden" style="height: 435px;">
                            ...
                            while ($row=mysqli_fetch_assoc($sql)) {
                              ...
                              ?>
                              <img class="img-fluid h-100" src="<?= 'foto_berita/'.$row['gambar']?>" style="object-fit: cover;">
                              <font color="#ff00000"><a href="<?php echo $row['isi_berita']?>" class="overlay align-items-center justify-content-center h4 m-0 text-dark text-white" ><?php echo $row['isi_berita']?></font>

                              </a>

                              <div class="overlay">
                                <div class="mb-1">
                                   <a class="text-white" href=""><?php echo $row['judul']?></a>
                                   <span class="px-2 text-white"></span>
                                   <a class="text-white" href="<?php echo $row['tanggal']?>"></a>
                               </div>
...
<div class="container-fluid py-3">
    <div class="container">
        <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
            <h3 class="m-0">Galery Safara Qolby</h3>
            <a class="text-secondary font-weight-medium text-decoration-none" href="">View All</a>
        </div>
        <div class="owl-carousel owl-carousel-2 carousel-item-4 position-relative">
            <div class="position-relative overflow-hidden" style="height: 300px;">
               <?php
               $no=1;
               $sql=mysqli_query($conn,"SELECT * FROM galery");
               while ($row=mysqli_fetch_assoc($sql)) {
                  ...
                  <img class="img-fluid w-100 h-100" src="<?= 'galery_album/'.$row['gambar']?>" style="object-fit: cover;">
                  <div class="overlay">
                    <div class="mb-1" style="font-size: 13px;">
                        <a class="text-white" href="<?php echo $row['nama']?>"></a>
                        <span class="px-1 text-white"><?php echo $row['nama']?></span>
                        <!--   <a class="text-white" href="">January 01, 2045</a> -->
                    </div>
